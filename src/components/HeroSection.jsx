      ...
      <div className="container max-w-4xl mx-auto text-center z-10">
        <div className="space-y-6 ">
          <h1 className="text-4xl md:text-6xl font-bold tracking-tight">
            ...
            <span className="text-primary opacity-0 animate-fade-in-delay-1">Amara </span>
            <span className="text-gradient ml-2 opacity-0 animate-fade-in-delay-2">Owanta-Emenike</span>
          </h1>

          <p 
            className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto opacity-0 animate-fade-in-delay-3 font-serif"
          >
